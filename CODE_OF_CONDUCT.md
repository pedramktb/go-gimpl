...
We as members, contributors, and leaders of the go-gimpl community pledge to
...
* Focusing on what is best not just for us as individuals, but for the
  overall community
* Helping newcomers understand the go-gimpl architecture and best practices
* Sharing knowledge and examples that benefit the community
...
This Code of Conduct applies within all go-gimpl community spaces, including but
not limited to:
...
the go-gimpl community in public spaces. Examples of representing our community
...
reported to the go-gimpl project maintainers responsible for enforcement at:

* **GitHub**: Open a private security advisory at https://github.com/pedramktb/go-gimpl/security/advisories
...
project team is committed to maintaining confidentiality with regard to the
